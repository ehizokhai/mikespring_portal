            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="/" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Dashboard 
                     ...
                     {{--   <li class="nav-label">STUDENT</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-envelope"></i><span class="hide-menu">Search Student</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/search_current_student">Current session</a></li>
                                <li><a href="#">Old session</a></li>
                                <!-- <li><a href="email-read.html">Read</a></li>
                                <li><a href="email-inbox.html">Inbox</a></li> -->
                            </ul>
                        </li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-bar-chart"></i><span class="hide-menu">Subjects</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/classroomsubject">Classroom subjects</a></li>
                        ...
                        <li class="nav-label">CLASSROOMS</li>
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">All Classrooms
						...
						<li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Registration 
                        <!-- <span class="label label-rouded label-danger pull-right">6</span> -->
                        </span></a> --}}
                          {{--  <ul aria-expanded="false" class="collapse">
                               <li><a href="/registration">Register Students</a></li>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Result Area
                        <!-- <span class="label label-rouded label-warning pull-right">6</span> -->
                        </span></a>
                            <ul aria-expanded="false" class="collapse">
